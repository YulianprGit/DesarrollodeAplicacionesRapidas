 ...
 * Description: Uun plugin personalizado para agregar widgets a Elementor.
 * Version: 1.0.0
 * Author: Yulian Paul Pacheco Ramírez
 */
...
function my_widgets_register_scripts(){
    wp_register_script("sketchfab-script", plugins_url("assets/js/sketchfab.js", __FILE__) , 
    ["jquery"], "1.0.0", true);
